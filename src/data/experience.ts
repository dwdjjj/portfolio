    ...
    workItems: [
      {
        ...
        bullets: [
          ...
          "전자상거래법·개인정보 보관 기준 등 처음 다루는 정책 영역을 조문 단위로 조사해 약관 14종과 환불 로직에 반영",
        ],
        results: [
          "2026.07.01 유료 정식 출시 — α 파일럿 → β 무료 체험단 → γ 유료 전환 3단계 완주",
          "feature flag 설계로 외부 결제 심사 3주 지연을 흡수 — 코드 롤백 없이 무료→유료 전환",
          "Redis 없이 PostgreSQL advisory lock + Caffeine으로 동시성 제어 — 상시 운영 컴포넌트 1개 감소, 인프라 월 약 $30 유지",
        ],
      },
      {
        ...
        results: [
          "푸시 열람률 33.9% — 3,802건 발송 / 1,290건 열람 (GA4)",
          "동의 UI 맥락 분리로 신규 유저 동의율 21.5% 확보 — 기존 바텀시트(12.6%) 대비 1.7배",
      ...
      },
      {
        ...
        results: [
          ...
          "이 기간 프론트엔드 변경량이 가장 집중된 영역 — 스케줄·배정·알림함까지 강사 플로우 전반을 재구성",
        ],
      },
      {
