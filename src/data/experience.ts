...
export const experience: Experience[] = [
  {
    ...
    current: true,
    summary:
      "교육 플랫폼의 결제·스케줄·푸시·체험단·타임딜 등 핵심 도메인을 React/Next.js로 구축·개선했습니다. 이후 신규 온라인 멘토링 플랫폼을 기획부터 배포까지 혼자 맡아 정식 출시까지 끌고 갔습니다.",
    workItems: [
      {
        ...
        bullets: [
          ...
          "전자상거래법·개인정보 보관 기준 등 처음 다루는 정책 영역을 조문 단위로 조사해 약관 16종과 환불 로직에 반영",
        ],
        results: [
          "2026.07.01 유료 정식 출시 — 기획부터 출시까지 3개월",
